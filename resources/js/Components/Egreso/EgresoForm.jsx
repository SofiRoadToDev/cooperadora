...
function EgresoForm() {
    ...
    return (
        <form
            class="flex flex-col bg-leaflighest p-5 shadow-md w-1/2 mb-5"
            method="POST"
        >
            ...
            <div class="grid grid-cols-3 grid-rows-1 gap-3">
                ...
                <select
                    ...
                    class="border my-2 border-slate-600 bg-white px-2  "
                >
                ...
                <label for="concepto" class="col-span-2">
                    Solicitante
                </label>
                <input
                    type="text"
                ...
                <input
                    ...
                    class="my-2 border border-slate-600 p-1 col-span-2"
                ></input>
            </div>
            <div class="grid grid-cols-3 grid-rows-1 gap-2">
                ...
                <input
                    ...
                    class="my-2 border border-slate-600 p-1 h-1/3"
                ></input>
                <textarea
                    type="text"
                    rows="3"
                    ...
                    class="my-2 border col-span-2 border-slate-600 p-1"
                ></textarea>
            </div>
            <button class="leaf-btn-main" type="submit" disabled={processing}>
                Enviar
            </button>
        </form>
    );
