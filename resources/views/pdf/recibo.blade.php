...
<body>
    <div class="grid grid-cols-4 border border-black min-h-[500px] mx-auto my-2 w-1/2 ">
        <div class="col-1 flex flex-col items-center bg-blue-100 p-5">
            ...
            <p class="text-center mb-6 font-semibold">{numero}</p>
        </div>
        <div id="cuerpo" class="relative col-span-3 border-l border-black bg-white p-5 flex flex-col">
            <div class="relative z-10 flex flex-col h-full">
                ...
                <p class="text-right mb-5 text-lg">Salta,{fecha}</p>
                <p class="text-left mb-5 text-lg">Recibí de {apellido}+{nombre}</p>
                <p class="text-left mb-5 text-lg">la suma de {importe_total}</p>
                <p class="text-left mb-5 text-lg">En concepto de {conceptos}</p>
                <div id="bottom" class=" border-black p-2 flex justify-between px-7 mt-auto">
                    <p class="text-left mb-5 text-lg">Son $ {importe_total}</p>
